...
public final class Compatibility {
    ...
    public static final PrboomComp[] prboom_comp = {
            new PrboomComp(0xffffffff, 0x02020615, false, "-force_monster_avoid_hazards"),
            new PrboomComp(0x00000000, 0x02040601, false, "-force_remove_slime_trails"),
            new PrboomComp(0x02020200, 0x02040801, false, "-force_no_dropoff"),
            new PrboomComp(0x00000000, 0x02040801, false, "-force_truncated_sector_specials"),
            new PrboomComp(0x00000000, 0x02040802, false, "-force_boom_brainawake"),
            new PrboomComp(0x00000000, 0x02040802, false, "-force_prboom_friction"),
            new PrboomComp(0x02020500, 0x02040000, false, "-reject_pad_with_ff"),
            new PrboomComp(0xffffffff, 0x02040802, false, "-force_lxdoom_demo_compatibility"),
            new PrboomComp(0x00000000, 0x0202061b, false, "-allow_ssg_direct"),
            new PrboomComp(0x00000000, 0x02040601, false, "-treat_no_clipping_things_as_not_blocking"),
            new PrboomComp(0x00000000, 0x02040803, false, "-force_incorrect_processing_of_respawn_frame_entry"),
            new PrboomComp(0x00000000, 0x02040601, false, "-force_correct_code_for_3_keys_doors_in_mbf"),
            new PrboomComp(0x00000000, 0x02040601, false, "-uninitialize_crush_field_for_stairs"),
            new PrboomComp(0x00000000, 0x02040802, false, "-force_boom_findnexthighestfloor"),
            new PrboomComp(0x00000000, 0x02040802, false, "-allow_sky_transfer_in_boom"),
            new PrboomComp(0x00000000, 0x02040803, false, "-apply_green_armor_class_to_armor_bonuses"),
            new PrboomComp(0x00000000, 0x02040803, false, "-apply_blue_armor_class_to_megasphere"),
            new PrboomComp(0x02050001, 0x02050003, false, "-wrong_fixeddiv"),
            new PrboomComp(0x02020200, 0x02050003, false, "-force_incorrect_bobbing_in_boom"),
            new PrboomComp(0xffffffff, 0x00000000, false, "-boom_deh_parser"),
            new PrboomComp(0x00000000, 0x02050007, false, "-mbf_remove_thinker_in_killmobj"),
            new PrboomComp(0x00000000, 0x02050007, false, "-do_not_inherit_friendlyness_flag_on_spawn"),
            new PrboomComp(0x00000000, 0x02050007, false, "-do_not_use_misc12_frame_parameters_in_a_mushroom")
    };
