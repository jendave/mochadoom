package net.sourceforge.mochadoom.rendering.parallel;

import net.sourceforge.mochadoom.doom.DoomMain;
import net.sourceforge.mochadoom.doom.player_t;
import java.io.IOException;
import net.sourceforge.mochadoom.rendering.SimpleThings;
import net.sourceforge.mochadoom.rendering.drawfuns.ColVars;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawColumnBoom;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawColumnBoomLow;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawColumnBoomOpt;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawColumnBoomOptLow;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawFuzzColumn;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawFuzzColumnLow;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawSpanLow;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawSpanUnrolled;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawTLColumn;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawTranslatedColumn;
import net.sourceforge.mochadoom.rendering.drawfuns.R_DrawTranslatedColumnLow;
