...
import net.sourceforge.mochadoom.gamelogic.Resettable;
import net.sourceforge.mochadoom.gamelogic.ThinkerList;
import net.sourceforge.mochadoom.gamelogic.fireflicker_t;
import net.sourceforge.mochadoom.gamelogic.glow_t;
import net.sourceforge.mochadoom.gamelogic.lightflash_t;
import net.sourceforge.mochadoom.gamelogic.mobj_t;
import net.sourceforge.mochadoom.gamelogic.strobe_t;
import net.sourceforge.mochadoom.gamelogic.vldoor_e;
import net.sourceforge.mochadoom.gamelogic.vldoor_t;
...
import static net.sourceforge.mochadoom.data.Limits.MAX_ADJOINING_SECTORS;
...
import static net.sourceforge.mochadoom.gamelogic.DoorDefines.STROBEBRIGHT;
