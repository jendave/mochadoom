...
public class doomdata_t implements IDatagramSerializable {
    ...
    public static final int DOOMDATALEN = 8 + net.sourceforge.mochadoom.data.Defines.BACKUPTICS * ticcmd_t.TICCMDLEN;
    ...
    */
    ...
    public doomdata_t() {
        cmds = new ticcmd_t[net.sourceforge.mochadoom.data.Defines.BACKUPTICS];
