...
public abstract class Zombie_t extends Monster_t{

  public Zombie_t(int doomednum, StateNum spawnstate, int spawnhealth, StateNum seestate, sfxenum_t seesound,
